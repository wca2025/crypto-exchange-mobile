...
class _PostAdState extends State<PostAd> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _PostAdMobile(
  
              ),
          tablet: _PostAdTablet(
...
class _PostAdTablet extends StatefulWidget {
  ...
  @override
  _PostAdTabletState createState() => _PostAdTabletState();
}

class _PostAdTabletState extends State<_PostAdTablet> {
...
class _PostAdMobile extends StatefulWidget {
  final _formKey = GlobalKey<FormBuilderState>();

  _PostAdMobile();

  @override
  _PostAdMobileState createState() => _PostAdMobileState();
}

class _PostAdMobileState extends State<_PostAdMobile> {
  final usernameController = TextEditingController();
  final passwordController = TextEditingController();
  final emailController = TextEditingController();
  final phoneController = TextEditingController();
