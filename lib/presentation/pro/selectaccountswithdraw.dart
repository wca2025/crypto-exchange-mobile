...
class SearchAccountsWithdraws extends StatefulWidget {
  const SearchAccountsWithdraws({Key? key}) : super(key: key);

  @override
  _SearchAccountsWithdrawsState createState() =>
      _SearchAccountsWithdrawsState();
}

class _SearchAccountsWithdrawsState extends State<SearchAccountsWithdraws>
                      ...
                      ListTile(
                        onTap: () {
                          Navigator.of(
                            ...
                            return Withdraw(accounttype: 'Main Account');
                          }));
                        },
                        title: Row(
                          children: [
