...
class _AutoTablet extends StatefulWidget {
  @override
  __AutoTabletState createState() => __AutoTabletState();
}

class __AutoTabletState extends State<_AutoTablet> {
...
class _AutoMobile extends StatefulWidget {
  @override
...
class _AutoMobileState extends State<_AutoMobile> {
  BestTutorSite _site = BestTutorSite.javatpoint;
  bool isSwitched = false;
                ...
                Container(
                    ...
                    child: ListTile(
                      title: InkWell(
                        ...
                        child: Text("Auto Cooling-Off Period",
                            style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 15 * textScale)),
                      ),
