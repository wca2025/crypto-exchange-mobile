...
class ProfileDetailHeader extends StatelessWidget {
  final String _content =
      " Virgo is a sapphire rarity tier hoiscope of 12 hprpsope nfts Profile that will be released for the upcoming amazing pandaverse ";
...
class ProfileMobile extends StatefulWidget {
  ...
  @override
  _ProfileMobileState createState() =>
      _ProfileMobileState(token: this.token, accounttype: this.accounttype);
}
...
class _ProfileMobileState extends State<ProfileMobile> {
  ...
  String? accounttype;
  _ProfileMobileState({this.token, this.accounttype});
                                ...
                                child: InkWell(
                                  ...
                                  child: Column(children: [
                                    Padding(
                                      ...
                                      child: Text(
                                        " Virgo is a sapphire rarity tier hoiscope of 12 hprpsope nfts Profile....",
                                        style: TextStyle(
                                            fontWeight: FontWeight.w400,
