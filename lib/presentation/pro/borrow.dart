...
import '../../presentation/pro/selectaccounts.dart';
...
class Borrow extends StatefulWidget {
  String? token;
  String? accounttype;
  Borrow({Key? key, this.token, this.accounttype}) : super(key: key);
  @override
  _BorrowState createState() =>
      _BorrowState(token: this.token, accounttype: this.accounttype);
}
...
class _BorrowState extends State<Borrow> {
  ...
  _BorrowState({this.token, this.accounttype});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _BorrowMobile(token: token, accounttype: accounttype),
          tablet: _BorrowTablet(),
        ),
      ),
    );
  }
...
class _BorrowTablet extends StatefulWidget {
  _BorrowTablet(
      // this.showResult, this.changeDisplay, this.setError, this.backToSignIn
      );

  @override
  __BorrowTabletState createState() => __BorrowTabletState();
}

class __BorrowTabletState extends State<_BorrowTablet> {
...
class _BorrowMobile extends StatefulWidget {
  String? token;
  String? accounttype;

  _BorrowMobile({Key? key, this.token, this.accounttype}) : super(key: key);

  @override
  _BorrowMobileState createState() =>
      _BorrowMobileState(token: this.token, accounttype: this.accounttype);
}

class _BorrowMobileState extends State<_BorrowMobile> {
  String? token;
  String? tokenlabel = 'Coin';
  String? accounttype;

  _BorrowMobileState({this.token, this.accounttype});
