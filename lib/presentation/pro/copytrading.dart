...
class _CopytradingMobile extends StatefulWidget {
  @override
  __CopytradingMobileState createState() => __CopytradingMobileState();

  _CopytradingMobile();
}

class __CopytradingMobileState extends State<_CopytradingMobile> {
...
class _CopytradingTablet extends StatefulWidget {
  @override
  __CopytradingTabletState createState() => __CopytradingTabletState();
}

class __CopytradingTabletState extends State<_CopytradingTablet> {
  List<TravelBean> _list = TravelBean.generateMostPopularBean();
...
class Copytrading extends StatefulWidget {
  @override
  _CopytradingState createState() => _CopytradingState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
        ...
        child: Scaffold(
          ...
          body: Container(
            child: Responsive(
              mobile: _CopytradingMobile(),
              tablet: _CopytradingTablet(),
            ),
          ),
        ));
  }
