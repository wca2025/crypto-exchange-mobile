...
class P2pbuy extends StatefulWidget {
  P2pbuy(
      // Function showResult,
  ...
  @override
  _P2pbuyState createState() => _P2pbuyState();
}

class _P2pbuyState extends State<P2pbuy> {
  // Function showResult;
...
class _P2pbuyTablet extends StatefulWidget {
  ...
  @override
  __P2pbuyTabletState createState() => __P2pbuyTabletState();
}

class __P2pbuyTabletState extends State<_P2pbuyTablet> {
...
class _P2pbuyMobile extends StatefulWidget {
  // final Function showResult;
  // final Function changeDisplay;
  // final Function setError;
  // final Function backToSignIn;
  ...
  @override
  _P2pbuyMobileState createState() => _P2pbuyMobileState();
}

class _P2pbuyMobileState extends State<_P2pbuyMobile> {
  final usernameController = TextEditingController();
  final passwordController = TextEditingController();
  final emailController = TextEditingController();
  final phoneController = TextEditingController();
