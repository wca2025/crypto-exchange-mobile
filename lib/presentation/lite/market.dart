                      ...
                      child:
                        ...
                        children: <Widget>[
                          ...
                          ListView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                              itemCount:8,
                            //itemCount:state.usdtcoin.length,
                            padding: const EdgeInsets.all(1.0),
                            itemBuilder: (context, index) {
                              var bean = _list[index];
                              return Container(
                          ...
                          ListView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                              itemCount:8,
                            //itemCount:state.ethcoin.length,
                            padding: const EdgeInsets.all(1.0),
                            itemBuilder: (context, index) {
                              var bean = _list[index];
                              return Container(
                          ...
                          ListView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                              itemCount:8,
                            //itemCount:state.daicoin.length,
                            padding: const EdgeInsets.all(1.0),
                            itemBuilder: (context, index) {
                              var bean = _list[index];
                              return Container(
                          ...
                          ListView.builder(
                            ...
                            scrollDirection: Axis.vertical,
                              itemCount:8,
                            //itemCount:state.solcoin.length,
                            padding: const EdgeInsets.all(1.0),
                            itemBuilder: (context, index) {
                              var bean = _list[index];
                              return Container(
              ...
              child: Align(
                ...
                child: TabBar(
                  ...
                  tabs: <Widget>[
                    ...
                    Tab(
                        child: Text("Layer 1/ Layer 2",
                            style: TextStyle(
                              fontSize: 12 * textScale,
                              fontWeight: FontWeight.w500,
                            ))),
                    Tab(
                        child: Text("Fan Token",
                            style: TextStyle(
                              fontSize: 12 * textScale,
                              fontWeight: FontWeight.w500,
                            ))),
