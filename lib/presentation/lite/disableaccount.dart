...
class disableAccount extends StatefulWidget {
  ...
  @override
  _disableAccountState createState() => _disableAccountState();
}
...
class _disableAccountState extends State<disableAccount> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _disableAccountMobile(
              // showResult, changeDisplay,
              //                         setError, _backToSignIn
              ),
          tablet: _disableAccountTablet(
              // showResult, changeDisplay,
              //                         setError, _backToSignIn
              ),
        ),
...
class _disableAccountTablet extends StatefulWidget {
  //  final Function showResult;
  // final Function changeDisplay;
  // final Function setError;
  // final Function backToSignIn;

  _disableAccountTablet(
      // this.showResult, this.changeDisplay, this.setError, this.backToSignIn
      );

  @override
  __disableAccountTabletState createState() => __disableAccountTabletState();
}

class __disableAccountTabletState extends State<_disableAccountTablet> {
...
class _disableAccountMobile extends StatefulWidget {
  // final Function showResult;
  // final Function changeDisplay;
  // final Function setError;
  // final Function backToSignIn;

  _disableAccountMobile(
      // this.showResult, this.changeDisplay, this.setError, this.backToSignIn
      );

  @override
  _disableAccountMobileState createState() => _disableAccountMobileState();
}

class _disableAccountMobileState extends State<_disableAccountMobile> {
  final usernameController = TextEditingController();
  final passwordController = TextEditingController();
  final emailController = TextEditingController();
  final phoneController = TextEditingController();
