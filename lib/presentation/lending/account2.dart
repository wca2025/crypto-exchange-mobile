...
class _Account2State extends State<Account2> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _Account2Mobile(),
          tablet: _Account2Tablet(),
        ),
      ),
    );
  }
...
class _Account2Tablet extends StatefulWidget {
  _Account2Tablet();

  @override
  __Account2TabletState createState() => __Account2TabletState();
}

class __Account2TabletState extends State<_Account2Tablet> {
  @override
  Widget build(BuildContext context) {
    final ScrollController _controller = ScrollController();
...
class _Account2Mobile extends StatefulWidget {
  _Account2Mobile();

  @override
  _Account2MobileState createState() => _Account2MobileState();
  final List<String> list = List.generate(10, (index) => "nutrinax $index");
}

class _Account2MobileState extends State<_Account2Mobile> {
            ...
            DefaultTabController(
                ...
                child: Scaffold(
                  ...
                  appBar: AppBar(
                      ...
                      title: Text('Account',
                          style: TextStyle(
                              fontSize: 16 * textScale, color: Colors.black))),
                  body: Scaffold(
                    backgroundColor: theme.backgroundColor,
                    body: Margin(),
                  ),
