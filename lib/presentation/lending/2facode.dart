...
class _TwofacodeState extends State<Twofacode> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _TwofacodeMobile(),
          tablet: _TwofacodeTablet(),
        ),
      ),
    );
  }
...
class _TwofacodeTablet extends StatefulWidget {
  _TwofacodeTablet();

  @override
  __TwofacodeState createState() => __TwofacodeState();
}

class __TwofacodeState extends State<_TwofacodeTablet> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Row(
          ...
          children: [
            Padding(padding: EdgeInsets.only(left: 12, top: 4)),
            Align(
...
class _TwofacodeMobile extends StatefulWidget {
  _TwofacodeMobile();

  @override
  _TwofacodeMobileState createState() => _TwofacodeMobileState();
}

class _TwofacodeMobileState extends State<_TwofacodeMobile> {
  final usernameController = TextEditingController();
  final passwordController = TextEditingController();
  final emailController = TextEditingController();
  final phoneController = TextEditingController();
