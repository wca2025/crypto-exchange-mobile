...
class _QrcodeState extends State<Qrcode> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        body: Responsive(
          mobile: _QrcodeMobile(),
          tablet: _QrcodeTablet(),
        ),
      ),
    );
  }
...
class _QrcodeTablet extends StatefulWidget {
  _QrcodeTablet(
      // this.showResult, this.changeDisplay, this.setError, this.backToSignIn
      );

  @override
  __QrcodeTabletState createState() => __QrcodeTabletState();
}

class __QrcodeTabletState extends State<_QrcodeTablet> {
...
class _QrcodeMobile extends StatefulWidget {
  _QrcodeMobile();

  @override
  _QrcodeMobileState createState() => _QrcodeMobileState();
}

class _QrcodeMobileState extends State<_QrcodeMobile> {
  final usernameController = TextEditingController();
  final passwordController = TextEditingController();
  final emailController = TextEditingController();
  final phoneController = TextEditingController();
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.all(2.0),
                                          child: Text(
                                            "A device is requesting permisson to login woth cx account ;",
                                            style: TextStyle(
                                                color: theme.hoverColor,
                                                fontSize: 14.0 * textScale),
